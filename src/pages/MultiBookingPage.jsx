...
import { Loader2, ArrowLeft, Calendar, Clock, AlertCircle, Building2, Users, XCircle } from 'lucide-react';
                      ...
                      <div className="bg-white rounded-[2rem] shadow-2xl border border-indigo-100 p-6">
                        <div className="flex items-center justify-between mb-4">
                          <div className="flex flex-col">
                            ...
                            <p className="text-sm font-bold text-indigo-900">{new Date().toLocaleDateString('en-IN', { month: 'long', year: 'numeric' })}</p>
                          </div>
                          <button 
                            type="button" 
                ...
                {fetchingSlots ? (
                  ...
                  <div className="flex flex-wrap gap-2 mt-3">
                    {STANDARD_SLOTS.map((slot, i) => {
                      const isBooked = disabledSlots.some(ds => isSlotStringOverlapping(ds, slot));
